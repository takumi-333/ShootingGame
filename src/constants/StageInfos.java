...
public class StageInfos {
	...
	public StageInfos() {
		...
		// 真ん中から出現
		BossEnemyStatus enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2, 0, 10, 200, 1, 3, 150, EnumEnemyType.BOSS, 100, 1, MyColors.BossEnemyColor1);
		...
		stage2.weakEnemyPower = 3;
		stage2.weakEnemyRate = 100;
		stage2.weakEnemyHp = 5;
		...
		// 真ん中から出現
		// 3体で一体のやつが出現
		enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2, 0, 75, 2000, 7, 3, 135, EnumEnemyType.BOSS, 900, 2, MyColors.BossEnemyColor2);
		enemy1.bulletSpeed = 7;
		stage2.enemyStatus.add(enemy1);
		enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2 - 30, 0, 90, 2500, 10, 3, 120, EnumEnemyType.BOSS, 900, 3, MyColors.BossEnemyColor2);
		enemy1.bulletSpeed = 8;
		stage2.enemyStatus.add(enemy1);
		enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2 + 30, 0, 75, 2000, 7, 3, 130, EnumEnemyType.BOSS, 900, 4, MyColors.BossEnemyColor2);
		enemy1.bulletSpeed = 6;
		stage2.enemyStatus.add(enemy1);
		
		// 2体の強めのやつ出現
		BossEnemyStatus enemy2 = new BossEnemyStatus(3 * (WindowSize.x - 10) / 4, 0, 28, 800, 5, 4, 125, EnumEnemyType.BOSS, 300, 1, MyColors.BossEnemyColor3);
		enemy2.bulletSpeed = 6;
		stage2.enemyStatus.add(enemy2);
		BossEnemyStatus enemy3 = new BossEnemyStatus((WindowSize.x - 10) / 4, 0, 28, 800, 5, 4, 120, EnumEnemyType.BOSS, 300, 1, MyColors.BossEnemyColor3);
		...
		stage3.weakEnemyPower = 16;
		stage3.weakEnemyRate = 180;
		stage3.weakEnemyHp = 45;
		stage3.weakEnemyBulletRate = 35;
		stage3.weakEnemyColor = MyColors.SalmonEnemyColor;
		stage3.bgColor = MyColors.StageBG3;
		
		enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2, 0, 300, 20000, 24, 2, 60, EnumEnemyType.BOSS, 10, 5, MyColors.BossEnemyColor4);
		...
		stage4.weakEnemyPower = 20;
		stage4.weakEnemyRate = 60;
		stage4.weakEnemyHp = 60;
		stage4.weakEnemyBulletRate = 45;
		stage4.weakEnemyColor = MyColors.SummerGreenEnemyColor;
		stage4.bgColor = MyColors.StageBG4;
		
		for (int i = 0; i < 4; i++) {
			enemy1 = new BossEnemyStatus( 2 * (i+1) * (WindowSize.x - 10) / 10, 0, 301, 15000, 50, 3, rnd.nextInt(5) + 95, EnumEnemyType.BOSS, 400, 0, MyColors.BossEnemyColor5);
			enemy1.bulletSpeed = rnd.nextInt(2) + 6;
			enemy1.movePattern = 1;
			stage4.enemyStatus.add(enemy1);
		}
		for (int i = 0; i < 6; i++) {
			enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2 , 0, 421, 50000, 50, 3, 100, EnumEnemyType.BOSS, 2500, 6, MyColors.BossEnemyColor6);
		...
		stage5.weakEnemyPower = 95;
		stage5.weakEnemyRate = 120;
		stage5.weakEnemyHp = 120;
		stage5.weakEnemyBulletRate = 35;
		stage5.weakEnemyColor = MyColors.TailGreenEnemyColor;
		stage5.bgColor = MyColors.StageBG5;
		
		
		enemy1 = new BossEnemyStatus((WindowSize.x - 10) / 2, 0, 2000, 100000, 1000, 0, 225, EnumEnemyType.BOSS, 100, 7, MyColors.BossEnemyColor7);
		enemy1.hasBeam = true;
		enemy1.bulletSize = 4;
		enemy1.movePattern = 0;
		enemy1.barrierPartId = enemy1.partId;
		stage5.enemyStatus.add(enemy1);
		enemy1 = new BossEnemyStatus(3 * (WindowSize.x - 10) / 4, 0, 1250, 50000, 100, 0, 150, EnumEnemyType.BOSS, 800, 7, MyColors.BossEnemyColor7);
		enemy1.hasBeam = true;
		enemy1.bulletSize = 4;
		enemy1.movePattern = 0;
		enemy1.barrierPartId = enemy1.partId;
		stage5.enemyStatus.add(enemy1);
		enemy1 = new BossEnemyStatus(1 * (WindowSize.x - 10) / 4, 0, 1250, 50000, 100, 0, 145, EnumEnemyType.BOSS, 800, 7, MyColors.BossEnemyColor7);
		enemy1.hasBeam = true;
		enemy1.bulletSize = 4;
		enemy1.movePattern = 0;
		enemy1.barrierPartId = enemy1.partId;
